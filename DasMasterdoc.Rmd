...
###kmeans 
```{r}
kmeans_result <- kmeans(Ctrl_pca$x, centers = 2, nstart = 25)
```
...
Ctrl_data$cluster <- as.factor(kmeans_result$cluster)
...
###kmeans 
```{r}
kmeans_result <- kmeans(rnase_pca$x, centers = 2, nstart = 25)
```
...
rnase_data$cluster <- as.factor(kmeans_result$cluster)
