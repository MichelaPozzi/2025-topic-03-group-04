...
heat_after  <- select_top_var(corrected_exp_ctrl, 100)
...
sampleInfo_R <- data.frame(
  rnase_fraction = factor(frnase_fraction),
...
proteins_right_shift <- right_shift_proteins_df$Protein
proteins_rbp <- Table_HS_RBP$Entry_Name
proteins_non_rbp <- Table_HS_Non_RBP$Entry_Name

is_in_rbp_or_nonrbp <- proteins_right_shift %in% proteins_rbp | proteins_right_shift %in% proteins_non_rbp
