...
# Zeile finden, die dem Protein entspricht (zur Sicherheit, falls nicht Zeile 4)
protein_row <- which(normalized_ctrl_df[, 1] == protein_id)

# Normierte Intensitäten für beide Bedingungen extrahieren
...
# Plot: leere Zeichenfläche vorbereiten
...
# Kontrolle: Fläche & Linie
polygon(c(fraktionen, rev(fraktionen)),
        c(rep(0, length(fraktionen)), rev(intensities_ctrl)),
        col = rgb(0.4, 0.4, 1, 0.3), border = NA)  # halbtransparentes Blau
lines(fraktionen, intensities_ctrl, col = "lavender", lwd = 2)

# RNase: Fläche & Linie
# RNase: Fläche & Linie
polygon(c(fraktionen, rev(fraktionen)),
        c(rep(0, length(fraktionen)), rev(intensities_rnase)),
        col = rgb(0, 0.4, 1, 0.3), border = NA)  # jetzt halbtransparentes Blau
lines(fraktionen, intensities_rnase, col = "lightblue", lwd = 2)
