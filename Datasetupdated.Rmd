...
percent_mean_ctrl_df  <- calculate_fraction_percentages(mean_ctrl_df)
percent_mean_rnase_df <- calculate_fraction_percentages(mean_rnase_df)

# Kontrolle
head(percent_mean_ctrl_df)
head(percent_mean_rnase_df)

# Zeilensummen berechnen (ab der zweiten Spalte)
zeilensumme <- rowSums(percent_mean_ctrl_df[, -1])
print(zeilensumme)
```
