...
boxplot(data = normalized_rnase_df, x = normalized_rnase_df$batch,
             y = normalized_rnase_df$value, title = 'OTU9 (Sponge)',
             batch.legend.title = 'Gel (batch)')

```

```{r}
ggplot(normalized_rnase_df, aes(x = value, fill = batch)) + 
