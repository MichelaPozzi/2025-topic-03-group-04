...
df_all <- rbind(
  df_positive_control[, c("EMD", "Shift_Distance_ctrl_to_rnase", "amplitude_changes", "Wilcoxon_statistic", "Center_of_Mass", "label")],
  df_negative_control[, c("EMD", "Shift_Distance_ctrl_to_rnase", "amplitude_changes", "Wilcoxon_statistic", "Center_of_Mass", "label")]
)

# 3. Fit logistic regression model with multiple predictors
logistic_model <- glm(label ~ EMD + Shift_Distance_ctrl_to_rnase + amplitude_changes + Wilcoxon_statistic + Center_of_Mass,
                      data = df_all,
                      family = binomial)
