...
df_positive_control$label <- 1  # Positive control group is labeled as 1
df_negative_control$label <- 0  # Negative control group is labeled as 0

# 2. Combine the datasets (only 'testscores' and 'label' columns)
df_all <- rbind(
...
# 5. Create a boxplot to compare test scores by label
boxplot(testscores ~ label, data = df_all,
        names = c("Negative", "Positive"),
        xlab = "Class Label", ylab = "Test Scores",
